...
import { Package, Calendar, DollarSign, MapPin, Clock } from "lucide-react";
...
export default function ProviderMyRentalItems() {
  const { user } = useAuth();

  const { data: rentalItems, isLoading } = useQuery<RentalItem[]>({
    queryKey: ['/api/provider/rental-items'],
    enabled: !!user,
  });
      ...
      <div className="container mx-auto p-6">
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Loading rental items...</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Track and manage items currently rented from your equipment</p>
      </div>
        ...
        <Card className="text-center py-12">
          <CardContent>
            ...
            <p className="text-gray-500 mb-6">
              You don't have any active rental items at the moment.
            </p>
            <Button>
