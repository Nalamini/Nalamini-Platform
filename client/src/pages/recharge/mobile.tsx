...
export default function MobileRechargePage() {
  ...
  const rechargeMutation = useMutation({
    mutationFn: async (data: RechargeFormValues) => {
      // Create the recharge
      const rechargeRes = await apiRequest("POST", "/api/recharge", data);
      ...
      return { recharge, serviceRequest };
    },
    onSuccess: (data) => {
      toast({
        title: "Recharge Successful",
        description: `Your mobile recharge for ₹${data.recharge.amount} was successful! Service request ${data.serviceRequest.srNumber} has been generated.`,
      });
