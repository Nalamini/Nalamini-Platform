...
export default function TaxiCustomerStable() {
  ...
  // Stable query key that doesn't cause re-renders
  const vehiclesQueryKey = useMemo(() => ["/api/taxi/vehicles", filters], [filters.district, filters.taluk, filters.pincode]);
  ...
  const handleCreateBooking = () => {
    ...
    const bookingData = {
      ...
      pickupPincode: filters.pincode || "600001",
  ...
  // Stable filtered vehicles calculation
  const availableVehicles = useMemo(() => 
    vehicles.filter((vehicle: TaxiVehicle) => 
          ...
          <div className="grid gap-4 md:grid-cols-3">
            <div className="space-y-2">
              ...
              <select 
                ...
                onChange={(e) => setFilters(prev => ({...prev, district: e.target.value, taluk: "", pincode: ""}))}
            ...
            <div className="space-y-2">
              ...
              <Input
                value={filters.taluk}
                onChange={(e) => setFilters(prev => ({...prev, taluk: e.target.value}))}
      ...
      <div className="mb-8">
        ...
        {filters.district ? (
          <p className="text-muted-foreground mb-4">
            Found {availableVehicles.length} vehicle(s) in {filters.district}
            {filters.taluk && `, ${filters.taluk}`}
