...
const dthRechargeSchema = z.object({
  mobileNumber: z
    .string()
    .min(5, "Subscriber ID must be at least 5 characters")
    .max(15, "Subscriber ID must not exceed 15 characters"),
  provider: z.string().min(1, "Please select a provider"),
  amount: z.string().min(1, "Amount is required"),
  serviceType: z.string().default("dth"),
});
...
type DTHRechargeFormValues = z.infer<typeof dthRechargeSchema>;
...
export default function DTHRechargePage() {
  ...
  // Initialize form
  const form = useForm<DTHRechargeFormValues>({
    resolver: zodResolver(dthRechargeSchema),
    defaultValues: {
      mobileNumber: "",
      provider: "",
      amount: "",
  ...
  const {
    ...
    queryKey: [`/api/recharge/plans/${selectedProvider}`, "dth"],
    queryFn: ({ queryKey }) => {
      return fetch(`${queryKey[0]}?serviceType=dth`).then(res => {
  ...
  const rechargeMutation = useMutation({
    mutationFn: async (data: DTHRechargeFormValues) => {
    ...
    onSuccess: (data) => {
      toast({
        ...
        description: `Your DTH recharge for ₹${data.amount} was successful.`,
      });
  ...
  function onSubmit(values: DTHRechargeFormValues) {
    // Submit the recharge
  ...
  return (
    <div className="container max-w-6xl py-6">
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-2xl font-bold tracking-tight">DTH Recharge</h1>
      </div>
        ...
        <div className="md:col-span-2">
          <Card className="h-full">
            <CardHeader>
              ...
              <CardDescription>Recharge your DTH connection with ease</CardDescription>
            </CardHeader>
            <CardContent>
              {viewMode === 'form' ? (
                <Form {...form}>
        ...
        <div>
          <Card>
            <CardHeader>
              ...
              <CardDescription>Your recent DTH recharges</CardDescription>
            </CardHeader>
            <CardContent>
              {isLoadingHistory ? (
                <div className="py-12 flex justify-center">
                ...
                <div className="space-y-3">
                  {rechargeHistory
                    .filter(recharge => recharge.serviceType === 'dth')
                    .slice(0, 5)
                    .map((recharge) => (
                      <div 
                        key={recharge.id} 
